  ...
  return (
    <div>
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Button onClick={exportCSV} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <tbody>
            {filteredStudents.map(student => (
              <tr key={student.id}>
                ...
                <td><Badge variant="section">{student.section}</Badge></td>
                <td>#{student.rank}</td>
                <td style={{ fontWeight: 600, color: 'var(--text-primary)' }}>{student.score}%</td>
                <td>
                ...
                <td><Badge variant={student.risk.toLowerCase()}>{student.risk}</Badge></td>
                <td>
                  <button 
